...
public class UserServiceImpl implements UserService {
	...
	public JoinRespDto join(JoinReqDto joinReqDto) throws ServerException {
		...
		memberServiceClient.join(
			new JoinRespToMembersDto(memberUuid, joinReqDto.getBirthDate(), joinReqDto.getGender(), deviceUuid,
				joinReqDto.getDeviceToken(), joinReqDto.getSelfIntroduction(), imageUrl, joinReqDto.getInterests(),
